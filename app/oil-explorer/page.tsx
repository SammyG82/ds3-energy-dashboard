        ...
        <MethodologySection cols={1} items={[
          {
            ...
            body: "Forecasts are produced by a Log-ARIMA model fitted separately for each country. The model parameters (p, d, q) are selected by minimising AIC across a grid search. The shaded band around each forecast line is a 95% confidence interval — wider bands mean the model is less certain about that country's trajectory.",
            plain: "Each country's forecast is generated by a statistical model that studies that country's own historical import pattern — how fast it was growing, whether growth was speeding up or slowing down — and extends that trend forward. It doesn't know about geopolitics or policy changes; it only extrapolates what the numbers have done in the past. The shaded band shows the range of plausible outcomes: a narrow band means the model is fairly confident, a wide band means the future is harder to call from the data alone.",
          },
        ]} />
      </div>
    </>
