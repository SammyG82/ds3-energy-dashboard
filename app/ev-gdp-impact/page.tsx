      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-10 flex flex-col gap-6">
        ...
        <MethodologySection cols={2} items={[
          ...
          },
          {
            ...
            body: "Displaced barrels are multiplied by a country-specific cost per barrel (a Brent-calibrated estimate from IEA cost data) to get the savings in billion USD. That figure is then divided by the country's 2023 nominal GDP (World Bank) to produce the percentage shown.",
          },
          {
